        ...
        <div className="row">
          ...
          <div className="col-md-4 product-description">
            ...
            <div className="card p-3 mt-3">
              <h6>Product Synopsis</h6>
              <p>
                {product.product_synopsis ||
                  "No synopsis available for this product."}
              </p>
            </div>
          </div>
        </div>

        {/* Seller Information Section Below the Row */}
          ...
          <div className="col-md-8">
            <div className="card p-3">
              ...
              <div className="d-flex justify-content-between w-100 mb-2">
                <p className="store-name mb-0">{product.store_name}</p>
                <div className="button-group">
                  <button className="btn btn-primary btn-sm">View Shop</button>
                  <button className="btn btn-secondary btn-sm">Message</button>
                </div>
              </div>
              <p className="store-province mb-0">{product.province}</p>
            </div>
          </div>
        </div>
      </div>
